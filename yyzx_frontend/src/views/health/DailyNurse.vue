...
import { queryCustomerNurseItem } from "@/api/customerNurseItemApi.js";
...
export default {
  computed: {
    ...
    indexMethodItem() {
      return (
        this.pageItem.currentPage * this.pageItem.pageSize -
  ...
  methods: {
    ...
    handleItemChange(curPage) {
      this.pageItem.currentPage = curPage;
    ...
    queryCustomerNurseItem() {
      queryCustomerNurseItem(this.conditionItem).then(res => {
        ...
        this.pageItem.currentPage = res.data.current; //当前页码
