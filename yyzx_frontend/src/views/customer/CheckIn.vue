     ...
     <div>
      ...
      <el-dialog
        ...
        >
          ...
          <el-form-item label="身份证号：" prop="idcCrd">
...
<script>
import { queryRoomList } from "@/api/roomApi.js";
import { findBedByRoom } from "@/api/bedApi.js";
import { addCustomer,listCustomerInfoPage ,delCustomer,updateCustomer} from "@/api/customerApi.js";
  ...
  data() {
    return {
      ...
      condition:{
        customerName:"",
        pageSize:"1",//默认第一页
        oldType:"1" //默认查询 1-自理老人 2-护理老人 3-历史老人
      },
      //分页属性封装
      page:{
        total:0,
